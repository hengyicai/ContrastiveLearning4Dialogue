...
class MSN(NeuralNetwork):
    ...
    def utterance_selector(self, key, context):
        ...
        s2 = torch.einsum("bud,bd->bu", context, key) / (
    ...
    def forward(self, bU, bR):
        ...
        bR_embedding = bR_embedding.unsqueeze(dim=1).repeat(1, su2, 1,
                                                            1)  # (batch_size, max_utterances, max_r_words, embedding_dim)
